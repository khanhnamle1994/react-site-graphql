	...
	<SocialContainer>
		...
		>
			<svg viewBox = "0 0 512 512" xmlns = "http://www.w3.org/2000/svg">
				...
				<path
					d = "m287 456v-299c0-21 6-35 35-35h38v-63c-7-1-29-3-55-3-54 0-91 33-91 94v306m143-254h-205v72h196"
					fill = "#fff"
				/>
			</svg>
		</SocialLink>
		...
		<SocialLink
			href = { `https://twitter.com/intent/tweet?text=${encodeURI(document.title)}&url=${encodeURI(window.location.href)}` }
			target = "_blank"
		>
			<svg viewBox = "0 0 512 512" xmlns = "http://www.w3.org/2000/svg">
				<rect height = "512" rx = "15%" width = "512" />
		...
		<SocialLink
			href = { `mailto:?subject=${document.title}&amp;body=Take a look at this article:\n${document.title}\n${window.location.href} ` }
		>
			<svg viewBox = "0 0 512 512" xmlns = "http://www.w3.org/2000/svg">
